...
export default function ItineraryDetailPage() {
  ...
  // Organize itinerary details by day
        ...
        <Card>
          ...
          <CardContent className="space-y-2">
            <div className="flex items-center justify-between">
              ...
              <span>
                {formatRupiah(itinerary.estimasi_biaya?.transportasi || 0)}
              </span>
            </div>
            <div className="flex items-center justify-between">
              <span>Accommodation</span>
              <span>
                {formatRupiah(itinerary.estimasi_biaya?.akomodasi || 0)}
              </span>
            </div>
            <div className="flex items-center justify-between">
              <span>Food</span>
              <span>{formatRupiah(itinerary.estimasi_biaya?.makan || 0)}</span>
            </div>
            <div className="flex items-center justify-between">
              <span>Entrance Tickets</span>
              <span>
                {formatRupiah(itinerary.estimasi_biaya?.tiket_wisata || 0)}
              </span>
            </div>
