          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="col-span-1 md:col-span-1">
              ...
              <p className="text-gray-600 text-sm mt-2">
                Platform perencanaan wisata pintar untuk menjelajahi keindahan Yogyakarta
                dengan rute dan itinerary yang disesuaikan dengan preferensi Anda.
              </p>
            </div>
            ...
            <div className="col-span-1">
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <Link href="#rekomendasi" className="text-gray-600 hover:text-primary-500 text-sm">
                    Rekomendasi
                  </Link>
                </li>
                <li>
                  <Link href="/tentang-kami" className="text-gray-600 hover:text-primary-500 text-sm">
                    Tentang Kami
                  </Link>
                </li>
                <li>
                  <Link href="/itinerary" className="text-gray-600 hover:text-primary-500 text-sm">
                    Itinerary
                  </Link>
                </li>
              </ul>
