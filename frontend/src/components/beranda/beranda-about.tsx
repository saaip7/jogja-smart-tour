...
export default function BerandaAbout() {
  return (
    <section className="w-full py-16 px-12" id="tentang-kami">
      <div className="mx-auto text-center relative z-10">
        <div className="inline-block">
          <div className="bg-primary-500 text-white font-medium py-1.5 px-6 rounded-full text-[14px]">TENTANG KAMI</div>
        </div>

        <h2 className="text-4xl font-bold mt-6 mb-4 text-neutral-900">Mengapa Memilih Jogja Smart Tour?</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-0 rounded-xl overflow-hidden relative h-[300px]">
      ...
      <div className="w-full py-32 px-10 ">
        <div className="grid gap-8 lg:grid-cols-[2fr_3fr] lg:gap-12 items-start">
          ...
          <div className="space-y-6">
            <h2 className="text-3xl font-semibold tracking-tight text-primary-700">Bagaimana Cara Kerja Jogja Smart Tour?</h2>
...
function FeatureCard({ icon, title, description, className }: FeatureCardProps) {
  return (
    <div className={`p-8 border-r border-primary-300 last:border-r-0 text-left ${className}`}>
